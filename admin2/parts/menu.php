	...
	<div class="sidebar-menu-inner">
		...
		<ul class="main-menu" id="main-menu" style="">
			<li class="active opened active has-sub root-level">
				<a href="index.html"><i class="entypo-gauge"></i><span class="title">Dashboard</span></a>
				<ul class="visible">
					<li class="active">
						<a href="index.html"><span class="title">Dashboard 1</span></a>
					</li>
					<li>
						<a href="../main-2/index.html"><span class="title">Dashboard
						2</span></a>
					</li>
					<li>
						<a href="../main-3/index.html"><span class="title">Dashboard
						3</span></a>
					</li>
					<li class="has-sub">
						...
						<ul>
							<li>
								<a href="../../skins/black/index.html"><span class="title">Black
								Skin</span></a>
							</li>
							<li>
								<a href="../../skins/white/index.html"><span class="title">White
								Skin</span></a>
							</li>
							<li>
								<a href="../../skins/purple/index.html"><span class="title">Purple
								Skin</span></a>
							</li>
							<li>
								<a href="../../skins/cafe/index.html"><span class="title">Cafe
								Skin</span></a>
							</li>
							<li>
								<a href="../../skins/red/index.html"><span class="title">Red
								Skin</span></a>
							</li>
							<li>
								<a href="../../skins/green/index.html"><span class="title">Green
								Skin</span></a>
							</li>
							<li>
								<a href="../../skins/yellow/index.html"><span class="title">Yellow
								Skin</span></a>
							</li>
							<li>
								<a href="../../skins/blue/index.html"><span class="title">Blue
								Skin</span></a>
							</li>
							<li>
					...
					<li>
						<a href="../highlights/index.html"><span class="title">What's
			...
			<li class="has-sub root-level">
				...
				<ul>
					...
					<li>
						<a href="../../layouts/chat-open/index.html"><span class="title">Chat
						Open</span></a>
					</li>
					<li>
					...
					<li>
						<a href="../../layouts/both-menus-right-sidebar/index.html"><span class="title">
						Both Menus (Right Sidebar)</span></a>
					</li>
					<li class="has-sub">
					...
					<li>
						<a href="../../layouts/boxed/index.html"><span class="title">Boxed
						Layout</span></a>
					</li>
				</ul>
			</li>
			...
			<li class="has-sub root-level">
				...
				<ul>
					...
					<li>
						<a href="../../ui/tabs-accordions/index.html"><span class="title">Tabs
						&amp; Accordions</span></a>
					</li>
					<li>
					...
					<li>
						<a href="../../ui/badges-label/s.html"><span class="title">Badges &amp;
						Labels</span></a>
					</li>
					<li>
			...
			<li class="has-sub root-level">
				...
				<ul>
					<li>
						<a href="../../forms/main/index.html"><span class="title">Basic
						Elements</span></a>
					</li>
					<li>
						<a href="../../forms/advanced/index.html"><span class="title">Advanced
						Plugins</span></a>
					</li>
					<li>
						<a href="../../forms/wizard/index.html"><span class="title">Form
						Wizard</span></a>
					</li>
					<li>
						<a href="../../forms/validation/index.html"><span class="title">Data
						Validation</span></a>
					</li>
					<li>
						<a href="../../forms/masks/index.html"><span class="title">Input
						Masks</span></a>
					</li>
					<li>
					...
					<li>
						<a href="../../forms/file-upload/index.html"><span class="title">File
						Upload</span></a>
					</li>
					<li>
			...
			<li class="has-sub root-level">
				...
				<ul>
					<li>
						<a href="../../tables/main/index.html"><span class="title">Basic
						Tables</span></a>
					</li>
					<li>
						<a href="../../tables/datatable/index.html"><span class="title">Data
						Tables</span></a>
					</li>
				</ul>
			</li>
			<li class="has-sub root-level">
				...
				<ul>
					...
					<li>
						<a href="../../extra/chat-api/index.html"><span class="title">Chat
						API</span></a>
					</li>
					<li>
					...
					<li>
						<a href="../../extra/404/index.html"><span class="title">404
						Page</span></a>
					</li>
					<li>
						<a href="../../extra/blank-page/index.html"><span class="title">Blank
						Page</span></a>
					</li>
					<li>
					...
					<li>
						<a href="../../extra/new-post/index.html"><span class="title">New
						Post</span></a>
					</li>
					<li>
					...
					<li>
						<a href="../../extra/image-crop/index.html"><span class="title">Image
						Crop</span></a>
					</li>
					<li>
						<a href="../../extra/search/index.html"><span class="title">Search
						Page</span></a>
					</li>
					<li>
					...
					<li>
						<a href="../../extra/nestable/index.html"><span class="title">Nestable
						Lists</span></a>
					</li>
					<li>
						<a href="../../extra/file-tree/index.html"><span class="title">File
						Tree</span></a>
					</li>
					<li>
						<a href="../../extra/load-progress/index.html"><span class="title">Load
						Progress</span></a>
					</li>
				</ul>
			</li>
			...
			<li class="has-sub root-level">
				...
				<ul>
					...
					<li class="has-sub">
						...
						<ul>
							<li>
								<a href="../../index.html#"><i class="entypo-flow-parallel"></i><span class="title">Menu Level
								2.1</span></a>
							</li>
							<li class="has-sub">
								<a href="../../index.html#"><i class="entypo-flow-parallel"></i><span class="title">Menu Level
								...
								<ul>
									<li class="has-sub">
										<a href="../../index.html#"><i class="entypo-flow-cascade"></i><span class="title">Menu Level
										3.1</span></a>
										<ul>
											<li>
												<a href="../../index.html#"><i class="entypo-flow-branch"></i><span class="title">Menu Level
												4.1</span></a>
											</li>
										</ul>
									</li>
